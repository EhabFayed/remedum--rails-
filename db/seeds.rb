...
[
  ...
  [ "MFDS", "اعتماد الرقابة الكورية", "Korean MFDS approval",
    ...
    "ترخيص الجهة الرقابية الكورية في بلد المنشأ .",
    "The Korean regulator's licence in the country of origin " ],
  ...
  [ "MDSAP", "التدقيق الدولي الموحد", "Medical Device Single Audit Program",
    ...
    "برنامج تدقيق موحّد تقبله جهات رقابية في عدة دول بتدقيق واحد.",
    "A single audit accepted by regulators in several countries ." ],
  ...
  [ "CE", "المطابقة الأوروبية", "European conformity",
    "European Conformity",
    "علامة المطابقة الأوروبية:  استيفاء المنتج لمتطلبات السلامة والأداء المعمول بها في السوق الأوروبي.",
